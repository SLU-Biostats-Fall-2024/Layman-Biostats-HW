...
p is very small, evidencing parasite treatment produces an effect on growth rate (there is a difference in means between groups)
Nice sentence - there is a statistically significant effect of parasite treatment on daphnia growth rate (Table 1. F (subscript 3,36) =32.325, p = 2.571e-10)
